...
TEST(GoertzelEncoderTest, Encode) {
  ...
  ASSERT_TRUE(io::ReadFromProtoInTextFormat(
      "src/encoder/goertzel_encoder_test_data/goertzel_medium_encoder_params.txt", &encoder_params));
...
TEST(GoertzelEncoderTest, DecodeEasy) {
  interface::EncoderParams encoder_params;
  ASSERT_TRUE(io::ReadFromProtoInTextFormat(
      "src/encoder/goertzel_encoder_test_data/goertzel_easy_encoder_params.txt", &encoder_params));
